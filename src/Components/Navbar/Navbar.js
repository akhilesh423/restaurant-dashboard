...
export default function Navbar() {
    ...
    return (
        <nav>
            <div className="navbar bg-white rounded-lg mb-3 flex justify-between p-2">
                <h1 style={textColor} className="font-serif italic text-3xl font-semibold text-stone-800">Bling and Bliss</h1>
                <ul className="flex">
                    <li className='p-1'>
            ...
            <div className={`sidebar ${openSidebar ? 'open' : ''} md:hidden`}>
