...
import { MdOutlineSpaceDashboard, MdOutlineFastfood } from "react-icons/md";
    ...
    return (
        <aside>
            <div className="p-3 bg-gradient-to-r from-neutral-900 to-neutral-950 h-screen pt-4 pb-4 h-dvh hidden md:block w-full">
                ...
                <ul className="">
                    <li className="flex items-center p-3 h-18 bg-blue-500 rounded-lg mt-3 hover:bg-cyan-600">
                    ...
                    <li className="flex items-center p-3 h-18  rounded-lg mt-3 hover:bg-neutral-500">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 fill-white">
